    ...
    public class AppUpdaterHelper : Java.Lang.Object, IRunnable
    {
        ...
        public void Run()
        {
            try
            {
                ...
                {
                    InitializeWoWonder.Initialize(AppSettings.TripleDesAppServiceProvider, Context.PackageName, AppSettings.TurnTrustFailureOnWebException, AppSettings.SetApisReportMode);
