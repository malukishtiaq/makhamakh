                    ...
                    try
                    {
                        ...
                        if (result != null)
                        {
                            ...
                            chatWindowActivity?.RunOnUiThread(async () =>
                            {
                                try
                                {
                                    var checker = chatWindowActivity.MAdapter.DifferList.FirstOrDefault(a => a.MesData.Id == messageHashId);
                                    if (checker != null)
                                    {
                ...
                client?.On("private_message", response =>
                {
                    try
                    {
                        ...
                        if (result != null)
                        {
                            ...
                            var chatWindowActivity = ChatWindowActivity.GetInstance();
                            if (chatWindowActivity != null && chatWindowActivity.MAdapter != null)
                            {
