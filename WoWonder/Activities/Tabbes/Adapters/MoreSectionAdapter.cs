                    ...
                    case StyleRowMore.Row:
                        {
                            ...
                            switch (AppSettings.ShowAddress)
                            {
                                case true:
                                    SectionList.Add(new SectionItem
                                    {
                                        Id = 105,
                                        SectionName = activityContext.GetText(Resource.String.Lbl_MyAddresses),
                                        BadgeCount = 0,
                                        StyleRow = StyleRowMore.Row,
                                        Badgevisibilty = false,
                                        IconAsImage = Resource.Drawable.icon_address_vector,
                                        Icon = IonIconsFonts.Pin,
                                        IconColor = Color.ParseColor("#0277BD")
                                    });
                                    break;
                            }
