                    ...
                    case AttachmentsAdapterViewHolder holder:
                        {
                            ...
                            if (item != null)
                            {
                                    ...
                                    default:
                                        {
                                            ...
                                            else
                                            {
                                                switch (item.TypeAttachment)
                                                {
                                                    ...
                                                    default:
                                                        Glide.With(ActivityContext?.BaseContext).Load(new File(item.FileUrl)).Apply(new RequestOptions().Placeholder(Resource.Drawable.ImagePlacholder).Error(Resource.Drawable.ImagePlacholder)).Into(holder.Image);
                                                        break;
                                                }
                                            }
                                ...
                                {
                                    holder.AttachType.SetImageResource(Resource.Drawable.icon_video_player_vector);
                                    holder.AttachType.Visibility = ViewStates.Visible;
                                }
