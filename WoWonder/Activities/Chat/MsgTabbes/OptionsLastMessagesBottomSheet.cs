...
{
    public class OptionsLastMessagesBottomSheet : BottomSheetDialogFragment, IDialogInputCallBack
    {
            ...
            try
            {
                ...
                if (Methods.CheckConnectivity())
                {
                    ...
                    else
                    {
                        ...
                        ToastUtils.ShowToast(Activity, Activity.GetText(Resource.String.Btn_UnBlock_successfully), ToastLength.Short);
                    }
                }
                else
                {
